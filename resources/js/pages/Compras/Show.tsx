                            ...
                            >
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="md:col-span-2">
                                        ...
                                        <dd className="mt-1 text-sm text-gray-900 dark:text-gray-100">
                                            {compra.detalles.length} {compra.detalles.length === 1 ? 'producto diferente' : 'productos diferentes'} • {calcularTotalProductos()} unidades totales
                                        </dd>
                                    </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    {compra.proveedor.email && (
                                        <div>
                                            ...
                                            <dd className="mt-1 text-sm text-gray-900 dark:text-gray-100">
                                                <a href={`mailto:${compra.proveedor.email}`} className="text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300">
                                                    {compra.proveedor.email}
                                                </a>
                                            </dd>
                                        </div>
                                    ...
                                    {compra.proveedor.telefono && (
                                        <div>
                                            ...
                                            <dd className="mt-1 text-sm text-gray-900 dark:text-gray-100">
                                                <a href={`tel:${compra.proveedor.telefono}`} className="text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300">
                                                    {compra.proveedor.telefono}
                                                </a>
                                            </dd>
                                        </div>
