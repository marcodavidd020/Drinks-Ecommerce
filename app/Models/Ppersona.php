...
/**
 * Modelo Ppersona - Personas que pueden ser proveedores
 * Representa una persona física que puede actuar como proveedor
 */
class Ppersona extends Model
{
    ...
    /**
     * Verificar si puede ser proveedor
     */
    public function puedeSerProveedor(): bool
    {
